                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment"
                                                                    style="line-height:10px"><img alt="Defiverso"
                                                                        src="<?php echo plugin_dir_url('cextoo-wordpress-plugin/public/images/email') . 'email/'; ?>fundo-p-email.png"
                                                                        style="display: block; height: auto; border: 0; width: 500px; max-width: 100%;"
                                                                        title="Defiverso" width="500" /></div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                ...
                                                <td class="column column-1"
                                                                ...
                                                                <div style="font-family: Tahoma, Verdana, sans-serif">
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p style=" font-size: 14px; text-align: left;">
                                                                            ...
                                                                            Essas pessoas confiam e respeitam uns aos
                                                                            outros e contribuem para que a nosso
                                                                        ...
                                                                        <p style=" font-size: 14px; text-align: left;">
                                                                            ...
                                                                            acredita que vai ficar rico amanha
                                                                        ...
                                                                        <p style=" font-size: 14px; text-align: left;">
                                                                            ...
                                                                            informações de maior qualidade em primeira
                                                                            mão, os quais irão lhe ajudar a entender o
                                                                            universo Defi e portanto capacita-lo para
                                                                            fazer melhores escolhas em seus
                                                                        ...
                                                                        <p style=" font-size: 14px; text-align: left;">
                                                                            ...
                                                                            terá acesso a plataforma do Defiverso e ao
                                                                            servidor do Discord. É indispénsavel que
                                                                            você assista o vídeo sobre como utilizar a
                                                    ...
                                                    <table border="0" cellpadding="10" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div style="font-family: Tahoma, Verdana, sans-serif">
                                                                    <p style=" margin-bottom: 14px;">Você
                                                                    ...
                                                                    <p style=" margin-bottom: 14px;">A partir
                                                                    ...
                                                                    <a href="<?php echo $link; ?>"
                                                                        ...
                                                                        target="_blank"><span
                                                                            style="padding-left:50px;padding-right:50px;font-size:18px;display:inline-block;letter-spacing:normal;"><span
                                                                                dir="ltr"
                                                                                style="word-break: break-word; line-height: 36px;">Clique
                                                                                aqui para definir o seu
                                                                                acesso</span></span></a>
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div style="font-family: Tahoma, Verdana, sans-serif">
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p style=" mso-line-height-alt: 19.5px;">
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>

                                                                ...
                                                                <div style="font-family: Tahoma, Verdana, sans-serif">
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            Provavelmente você não viu o e-mail que mandamos ontem para você, portanto essa é a sua ultima chance de continuar participando da nossa comunidade de viciados em Defi e continuar recebendo os conteúdos do Defiverso.</p>
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 18px;">
                                                                        </p>
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: left;">
                                                                            Hoje é o seu último dia para renovar a sua assinatura no Defiverso, para fazer a renovação basta clicar no link abaixo:
                                                                        </p>
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 18px;">
                                                                        </p>
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment"
                                                                    ...
                                                                    <div align="center" class="alignment">
                                                                        <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="<?php echo get_site_url(null, '/minha-conta'); ?>" style="height:58px;width:400px;v-text-anchor:middle;" arcsize="35%" strokeweight="0.75pt" strokecolor="#35FF27" fillcolor="#24901b"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#ffffff; font-family:Tahoma, Verdana, sans-serif; font-size:18px"><![endif]-->
                                                                        <a href="<?php echo get_site_url(null, '/minha-conta'); ?>"
                                                                           style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#24901b;border-radius:20px;width:auto;border-top:1px dotted #35FF27;font-weight:400;border-right:1px dotted #35FF27;border-bottom:1px dotted #35FF27;border-left:1px dotted #35FF27;padding-top:10px;padding-bottom:10px;font-family:Tahoma, Verdana, Segoe, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;"
                                                                           target="_blank"><span
                                                                                    style="padding-left:50px;padding-right:50px;font-size:18px;display:inline-block;letter-spacing:normal;"><span
                                                                                        dir="ltr"
                                                                                        style="word-break: break-word; line-height: 36px;">Link de Renovação</span></span></a>
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0; margin-bottom: 16px;">Caso você escolha não fazer, você perderá imediatamente o acesso ao Defiverso e ao Discord. Como as vagas são limitadas, não existem garantias de que você consiga ingressar novamente em um futuro próximo. </p>
                                                                    <p style="margin: 0; margin-bottom: 16px;">Qualquer dúvida estamos a disposição, basta enviar um e-mail para <a href="mailto:suporte@defiverso.com">suporte@defiverso.com</a></p>
